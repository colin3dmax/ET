...
static NSString *DefaultScaleMenuLabels[] = {
  @"20%", @"30%", @"50%", @"75%", @"100%", @"130%", @"160%", @"200%", @"250%", @"300%", @"600%", @"800%", @"1000%"
};
static float DefaultScaleMenuFactors[] = {
  0.2f, 0.3f, 0.5f, 0.75f, 1.0f, 1.3f, 1.6f, 2.0f, 2.5f, 3.0f, 6.0f, 8.0f, 10.0f
};
...
- (void) createItems
{
  ...
  mCaretPositionLabel = [[NSTextField alloc] initWithFrame: NSMakeRect(0.0, 0.0, 200.0, 1.0)];
  ...
  [mCaretPositionLabel setDrawsBackground: NO];
    ...
    [mCaretPositionLabel setTextColor:[NSColor whiteColor]];
  ...
  [mStatusTextLabel setFont: [NSFont menuBarFontOfSize: BarFontSize]];
    [mStatusTextLabel setTextColor:[NSColor whiteColor]];
...
- (void) setCaretPosition: (NSPoint) position
{
  ...
  if (mCurrentCaretX != newX || mCurrentCaretY != newY)
  {
    ...
    [mCaretPositionLabel setStringValue: [NSString stringWithFormat: @"Line %d,Column %d", newX, newY]];
  }
}
